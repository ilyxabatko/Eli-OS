...
lazy_static! {
    static ref IDT: InterruptDescriptorTable = {
        ...
        idt[HardwareInterruptIndex::Timer.as_usize()].set_handler_fn(timer_interrupt_handler);
        idt[HardwareInterruptIndex::Keyboard.as_usize()].set_handler_fn(keyboard_interrupt_handler);
...
extern "x86-interrupt" fn keyboard_interrupt_handler(_stack_frame: InterruptStackFrame) {
    ...
    let mut port = Port::new(PS_2_CONTROLLER_PORT);
